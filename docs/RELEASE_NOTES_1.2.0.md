...
Sparring를 SCHNAIL 설치본 없이 독립 실행할 수 있게 하고, 래더 매칭을 실제 MMR 래더에 가깝게 다듬은 마이너 릴리즈입니다.

## 주요 변경

- Sparring 봇/맵/핫키 자산을 `data` 폴더에 포함해 최종 사용자가 SCHNAIL Client를 설치하지 않아도 됩니다.
...
1. `Sparring-1.2.0-win-x64.zip`을 다운로드합니다.
2. ZIP 파일의 압축을 풉니다.
