    ...
    public static PracticeCatalog Read(string assetRoot)
    {
        ...
        if (!File.Exists(botsDat))
        {
            throw new FileNotFoundException(
                "Sparring bundled bot catalog was not found. Run scripts\\import-schnail-assets.ps1 during release preparation.",
                botsDat);
        }
        ...
        {
            throw new FileNotFoundException(
                "Sparring bundled map catalog was not found. Run scripts\\import-schnail-assets.ps1 during release preparation.",
                mapsDat);
        }
