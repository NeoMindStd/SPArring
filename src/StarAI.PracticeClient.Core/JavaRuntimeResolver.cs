...
public static class JavaRuntimeResolver
{
    ...
    public static IReadOnlyList<string> BuildCandidatePaths(PracticePaths paths)
    {
        ...
        AddIfPresent(candidates, Environment.GetEnvironmentVariable("STARAI_JAVA_HOME"));
    ...
    public static string ResolveJavaExe(PracticePaths paths)
    {
        ...
        throw new InvalidOperationException(
            "Java 11+ runtime was not found. Install the StarAI Java runtime option or install Java manually to apply custom hotkeys.");
    }
